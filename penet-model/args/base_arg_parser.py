...
class BaseArgParser(object):
    ...
    def __init__(self):
        ...
        # Accept both --gpu_ids and --gpu-ids for convenience
        self.parser.add_argument('--gpu_ids', '--gpu-ids', dest='gpu_ids', type=str, default='0,1,2',
    ...
    def parse_args(self, args_list=None):
        """Parse CLI arguments and perform post-processing.

        Args:
            args_list: Optional list of argument strings (excluding program name). If None, parses sys.argv.
        """
